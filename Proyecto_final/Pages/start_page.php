		...
		<div id="main">
			...
			<div class="movie">
				<div class="movie_inner">
					<a href="#"><img class="image_desc" src="../Imagenes/test.jpg" alt="imagen no disponible"></a>
				...
				<?php foreach ($categories as $category): ?>
						<div class="movie">
							<div class="movie_inner">
								<a href="main.php?id=<?= $category['id'] ?>"> <img class="image_desc" src="../Imagenes/test.jpg" alt="imagen no disponible"></a>
								<div class="movie_info">
									<div class="title_movie font_style">
										<?= $category['nombre'] ?>
									</div>
